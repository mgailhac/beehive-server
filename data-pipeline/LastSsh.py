        ...
        for nodeInfo in nodeInfos:
            ...
            if len(values) == 2: # and values[1] == '50027':
                ...
                try:
                    ...
                    cmd = """/usr/bin/ssh -o StrictHostKeyChecking=no -o ProxyCommand='/usr/bin/docker exec -i beehive-sshd nc -q0 localhost {}' -i /mnt/ssh_keys/id_rsa_waggle_aot_test waggle@ -- date 2> /dev/null""".format(port)
